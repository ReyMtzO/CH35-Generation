...
@RequestMapping("admin/users")  //Construimos la ruta de nuestra API definiendoo endpoints (localhost:8080/admin/users)
public class UserController {
	...
	//Necesitamos decirle a controller que tiene que traer la información de UserService usando el método definido. Para traer la información (READ) necesitamos indicar el tipo de petición (Get) mediante la anotación @GetMapping
	@GetMapping
