...
/*
 * En Service definiremos los servicios de la base de datos. Emulamos una DB utilizando un ArrayList para realizar las operaciones del CRUD, aunque solo vamos a realizar Read mediante un protocolo HTTP GET.
