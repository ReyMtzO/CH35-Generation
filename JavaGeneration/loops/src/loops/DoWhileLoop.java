...
public class DoWhileLoop {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		System.out.println("Bienvenido al banco City Generation, elija alguna de nuestras opciones disponibles");
		...
		do {
			...
			case 4: System.out.println("Salir, tomar efectivo y/o recibo");
				break;
				default: System.out.println("Por favor, elija alguna de nuestras opciones disponibles");
				break;
			}
		} while (option != 4);
		...
		*/
		...
		/*
		 * - Puedes usar el scanner y guardar el valor en otra variable: case 2:
			...
			case 3:
				...
				- Utilizas scanner.nextInt(); pero guardas el valor que se ingresa en 				  otra variable
				- Utiliza nextInt() siempre y cuando tu variable sea de tipo int.
				- Si tu variable es de tipo boolean usas nextBoolean()
		 * */
		...
		//Instrucciones
		//1. Usa import java.util.Scanner; (en la lìnea 2)
		//2. Utiliza Scanner scanner = new Scanner(System.in); (Dentro de
		// public static void main(String[] args) { AQUI }
		...
		boolean repetir = true; //Es la condición que me permite ejecuar mi ciclo do-while siempre que sea "verdadera"
				...
				do {
					...
					Scanner scr = new Scanner(System.in);	
					opcion = scr.nextInt(); //permite reasignar el valor de "opcion" por el nuevo valor ingresado a traves del scanner
					...
					case 2: //Si la opción es 2
						System.out.println("Ingrese el monto por añadir");
							añadir = scr.nextInt(); //permite añadir saldo a traves del scanner y lo reescribe en la variable "añadir"
							dinero+=añadir; //suma la nueva cantidad al saldo guardado en la variable "dinero"
						break;
					case 3: //Si la opción es 3
						System.out.println("Ingrese el monto a retirar ");
						retirar = scr.nextInt(); //permite retirar dinero a traves del scanner y reescribe el monto a retirar en la variable "retirar"
					...
					repetir = scr.nextBoolean(); //reasigna el valor de la variable repetir segun lo ingresado por el usuario a traves de scanner.
