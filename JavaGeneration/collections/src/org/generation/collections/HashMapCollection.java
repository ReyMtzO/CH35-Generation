...
public class HashMapCollection {
	public static void main(String[] argas) {
		...
		//Map.Entry<> es un método de la interfaz Map que representa una entrada de un Map. Toma como argumento los tipos de datos asignados al HashMap. El usuario asigna el nombre de la interfaz y recibe un método .entrySet() que devuelve el conjunto (Set) de las entradas (clave/valor) en el HashMap.
