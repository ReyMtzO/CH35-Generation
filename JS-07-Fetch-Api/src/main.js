...
const mostrarProductos = (productos) => {
    // Mando a llamar las llaves de tittle, price, description, category, image, desde la API
...
const getUser = async () => {
    ...
    try {
        // Retardo para que se ejecute de manera asíncrona. Tengo que crear una vuena promesa, que recibe un setTimeout
